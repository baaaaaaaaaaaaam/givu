...
public class mypage_donate_Adapter  extends RecyclerView.Adapter<mypage_donate_Adapter.ViewHolder>{

    private ArrayList<response_mypage_donate> mData ;


    public mypage_donate_Adapter(ArrayList<response_mypage_donate> mData){
        this.mData=mData;
    ...
    @NonNull
    @Override
    public mypage_donate_Adapter.ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View v = LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.item_mypage_donate_list, null);

        return new mypage_donate_Adapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder( mypage_donate_Adapter.ViewHolder holder, int position) {

        response_mypage_donate object=mData.get(position);
        ...
        holder.donate.setText(object.getDonate_money() +" 원");
        ...
        if(mListener!=null){
            ...
            holder.touch_ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mListener.onItemClicked(pos,"donate");
                }
            });
        }
