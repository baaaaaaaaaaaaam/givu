...
function networkDown() {
  ...
  echo "asset-transfer-ledger-queries 지갑 체크"
  if [ -d "/home/ubuntu/test/fabric-samples/asset-transfer-ledger-queries/application-javascript/wallet" ]; then
    echo "asset-transfer-ledger-queries 지갑 지움"
    rm -rf ../asset-transfer-ledger-queries/application-javascript/wallet
  fi
